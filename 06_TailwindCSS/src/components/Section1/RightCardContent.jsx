  ...
  return (
    <div>
      <div className='absolute top-0 left-0 h-full w-full p-10 flex flex-col justify-between'>
        ...
        <div>
            <p className='text-lg leading-normal text-white mb-12 text-shadow-2xs'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione obcaecati similique consectetur veniam. Deleniti vero aliquid obcaecati omnis! Asperiores, voluptatibus!</p>
